...
export const SKEPOID = 'SKEPOID'
export const SER_USERINFOH = 'SER_USERINFOH'

//设置关注数
export const SER_FOOLOW = 'SER_FOOLOW'
//设置喜欢数量
export const SER_LIKE = 'SER_LIKE'
//夺宝需要授权记录回跳页面 
export const SER_SHEOWHS = 'SER_SHEOWHS'

//获取用户信息重要 
export const SET_QUHAOPO = 'SET_QUHAOPO'

//获取更新购物车信息
export const SET_MUCART = 'SET_MUCART'


//获取地址列表id
export const SET_ADDRESSIS = 'SET_ADDRESSIS'
